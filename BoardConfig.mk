...
# Kernel
BOARD_KERNEL_CMDLINE := bootopt=64S3,32N2,64N2 androidboot.selinux=permissive console=ttyGS0,115200
...
TARGET_KERNEL_SOURCE := kernel/planetcom/mt6771
...
TARGET_OTA_ASSERT_DEVICE := Cosmo_Communicator,cosmocom
